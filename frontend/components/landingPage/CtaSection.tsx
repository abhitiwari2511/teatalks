    ...
    <div>
      <div className="container mx-auto px-4 py-20">
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-3xl mx-auto bg-primary text-primary-foreground border-4 border-border rounded-3xl p-12 text-center shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden"
        >
          ...
          <h2 className="text-4xl md:text-5xl mb-6 italic">
